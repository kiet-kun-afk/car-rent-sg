						...
						<div className="container-custom">
							...
							<div className="row">
								<div className="col-md-8">
									...
									<div
										className="info-car-desc line-bottom"
										id="outsfeatures"
									>
										<h6>Đặc điểm</h6>
									...
									<div className="info-car-desc">
										...
										<div className="required-papers">
											<p>
												15 triệu (tiền mặt/chuyển khoản
												cho STK Carrentsg khi nhận xe)
												hoặc Xe máy (kèm cà vẹt gốc) giá
												trị 15 triệu
											</p>
										</div>
									</div>
									...
									<div className="info-car-desc">
										...
										<pre>
											...
											◦ Không sử dụng xe thuê vào mục đích
											phi pháp, trái pháp luật. <br />
											◦ Không sử dụng xe thuê để cầm cố,
											thế chấp. <br />
											◦ Không hút thuốc, nhả kẹo cao su,
											xả rác trong xe. <br />
											◦ Không chở hàng quốc cấm dễ cháy
											nổ. <br />
											◦ Không chở hoa quả, thực phẩm nặng
											mùi trong xe. <br />
											◦ Khi trả xe, nếu xe bẩn hoặc có mùi
											trong xe, khách hàng vui lòng vệ
											sinh xe sạch sẽ hoặc gửi phụ thu phí
											vệ sinh xe. <br />
											Trân trọng cảm ơn, chúc quý khách
											hàng có những chuyến đi tuyệt vời !
										</pre>
									</div>
									<div className="info-car-desc">
									...
									>
										...
										<form onSubmit={handleCreateContract}>
											...
											{isLoggedIn ? (
												...
												<a
													class="btn btn-primary btn--m width-100"
