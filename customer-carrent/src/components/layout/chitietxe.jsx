...
function DetailCar() {
	...
	const findCustomer = async () => {
		try {
			const response = await axiosConfig.get("http://localhost:8080/api/v1/customers/current-customer");
	...
	const handleCreateContract = async (e) => {
		...
		if (customer.driverLicenseId) {
			...
			try {
				const response = await axios.post(`http://localhost:8080/api/v1/contracts/create/${id}`, formData, {
					headers: {
			...
			setErrorMessage(t("Vui lòng cập nhật giấy phép lái xe trước khi thuê"));
		}
	};
						...
						<div className="container-custom">
							<div className="row">
								<div className="col-md-8 left-img">
									<img src={`${car.frontImage}`} alt="Car Image" className="img-fluid" />
								</div>
								<div className="col-md-4 right-img">
									<img src={`${car.backImage}`} alt="Car Image" className="img-fluid mb-2" />
									<img src={`${car.rightImage}`} alt="Car Image" className="img-fluid mb-2" />
									<img src={`${car.leftImage}`} alt="Car Image" className="img-fluid mb-2" />
								</div>
							</div>
							<div className="row">
								<div className="col-md-8">
									...
									<div className="info-car-desc line-bottom" id="outsfeatures">
										...
										<div className="outstanding-features">
											...
											{car.fuelConsumption === null || car.fuelConsumption === "NULL" ? (
												<div></div>
											) : (
												<div>
													<div className="outstanding-features__item">
									...
									<div className="info-car-desc">
										...
										<div className="cancel-policy">
											<div className="column title">
												<div className="column__item case">{t("time_of_cancellation")}</div>
												<div className="column__item">{t("renter_cancellation")} </div>
												<div className="column__item">{t("owner_cancellation")} </div>
											</div>
											<div className="column">
												<div className="column__item case">{t("within_1_hour")}</div>
											...
											<div className="column">
												<div className="column__item case">{t("before_7_days")}</div>
												<div className="column__item">
													<div className="wrap-svg">
														<svg
															width="24"
											...
											<div className="column">
												<div className="column__item case">{t("within_7_days")}</div>
												<div className="column__item">
													<div className="wrap-svg">
														<svg
															width="24"
								...
								<div className="col-md-4">
									...
									<div className="surcharge">
										<p className="title text-primary">{t("surchargeTitle")}</p>
