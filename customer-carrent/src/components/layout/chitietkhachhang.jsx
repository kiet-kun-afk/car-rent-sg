...
function DeitalCustomer() {
    ...
    const updateInfor = async (e) => {
        ...
        try {
            ...
            if (customerAccount) {
                const res = await axiosConfig.put("http://localhost:8080/api/v1/customers/update-information", formData, {
                    headers: {
    ...
    const updatePhone = async (e) => {
        ...
        try {
            ...
            if (customerAccount) {
                const res = await axiosConfig.put(`http://localhost:8080/api/v1/customers/update-phone-number`, null, {
                    params: {
            ...
            ToastComponent('success', 'Cập nhật số điện thoại thành công. Vui lòng đăng nhập lại!');
            setTimeout(() => {
                handleLogout();
            }, 4000);
    ...
    const updateEmail = async (e) => {
        ...
        try {
            ...
            if (customerAccount) {
                const res = await axiosConfig.put(`http://localhost:8080/api/v1/customers/update-email`, null, {
                    params: {
                        email: email
                    }
                });
            ...
            ToastComponent('success', 'Cập nhật số email thành công. Vui lòng đăng nhập lại!');
            setTimeout(() => {
                handleLogout();
            }, 4000);
    ...
    const updateImage = async (e) => {
        ...
        try {
            ...
            if (customerAccount) {
                const res = await axiosConfig.put(`http://localhost:8080/api/v1/customers/update-avatar`, formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                });
    ...
    return (
        <>
                        ...
                        <div className="account-container">
                            <div className="sidebar-account">
                                <div>
                                    ...
                                    <div className="sidebar-account-sticky" style={{ transform: "translateZ(0px)" }}>
                                        <div className="title">
                                            <h1>Xin chào bạn!</h1>
                                        </div>
                                        <div className="sidebar">
                                            <Link to="/carrentsg/customer/infor">
                                                <div className="sidebar-item active" aria-current="page">
                                                ...
                                                <div className="sidebar-item">
                                                    <div className="wrap-svg">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                            ...
                                                            <path d="M7.89001 6.85999H8.92001" stroke="black" strokeWidth="1.5"
                                                                strokeLinecap="round" strokeLinejoin="round">
                                                            </path>
                                                            <path d="M12 6.85999H16.11" stroke="black" strokeWidth="1.5"
                                                                strokeLinecap="round" strokeLinejoin="round">
                                                            </path>
                                                            <path d="M7.89001 12H8.92001" stroke="black" strokeWidth="1.5"
                                                                strokeLinecap="round" strokeLinejoin="round">
                                                            </path>
                                                            <path d="M12 12H16.11" stroke="black" strokeWidth="1.5"
                                                                strokeLinecap="round" strokeLinejoin="round">
                                                            </path>
                                                            <path d="M7.89001 17.14H8.92001" stroke="black" strokeWidth="1.5"
                                                                strokeLinecap="round" strokeLinejoin="round">
                                                            </path>
                                                            <path d="M12 17.14H16.11" stroke="black" strokeWidth="1.5"
                                                                strokeLinecap="round" strokeLinejoin="round">
                                                            </path>
                                                        </svg>
                                                    </div>
                                                ...
                                                <div className="sidebar-item">
                                                    <div className="wrap-svg">
                                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                                            ...
                                                            <path d="M6 10V8C6 4.69 7 2 12 2C17 2 18 4.69 18 8V10" stroke="black"
                                            ...
                                            <div className="sidebar-item">
                                                <div className="wrap-svg">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        ...
                                                        <path d="M14.9993 12H2.7793" stroke="black" strokeWidth="1.5"
                                                            strokeLinecap="round" strokeLinejoin="round">
                                                        </path>
                                                        <path d="M2.75 12L6.75 16" stroke="black" strokeWidth="1.5"
                                                            strokeLinecap="round" strokeLinejoin="round">
                                                        </path>
                                                        <path d="M2.75 12L6.75 8" stroke="black" strokeWidth="1.5"
                                                            strokeLinecap="round" strokeLinejoin="round">
                                                        </path>
                                                    </svg>
                                                </div>
                                                <a data-bs-toggle="modal" data-bs-target="#customerLogout">Đăng xuất</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div className="modal fade" id="updateCustomer" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div className="input-box">
                                    ...
                                    <form>
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" value={fullName} onChange={onFullnameChange} />
                                        </div>
                                        <div className="mb-3">
                                            <label className="form-label">Ngày sinh</label>
                                            <input type="date" className="form-control" value={dob} onChange={onDobChange} />
                                        </div>
                                        <div className="mb-3">
                                        ...
                                        <div className="input-field mt-3">
                                            <button type="submit" className="btn-submit" onClick={updateInfor}>Cập nhật</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            <div className="modal fade" id="updatePhone" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-body p-0">
                            <div className="d-flex flex-row-reverse p-2">
                                ...
                                <div className="input-box">
                                    ...
                                    <form>
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" value={phoneNumber} onChange={onPhoneChange} />
                                        </div>
                                        <div className="input-field mt-3">
                                            <button type="submit" className="btn-submit" onClick={updatePhone}>Cập nhật</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            <div className="modal fade" id="updateEmail" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-body p-0">
                            <div className="d-flex flex-row-reverse p-2">
                            ...
                            <div className="form-item">
                                <div className="input-box">
                                    ...
                                    <form>
                                        ...
                                        <div className="input-field mt-3">
                                            <button type="submit" className="btn-submit" onClick={updateEmail}>Cập nhật</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            {/* Modal Infor-Address */}
            <div className="modal fade" id="updateAddress" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div className="content">
                                                <div className="address-type m-3">
                                                    <div className="mb-3">
                                                        ...
                                                        <input type="text" className="form-control" placeholder='Nhập tên cho địa chỉ của bạn' />
                                                    </div>
                                                </div>
                                                <div className="row m-3">
                                                    <div className="address-type col-sm-4 ps-0">
                                                        ...
                                                        <div className="custom-select">
                                                            <select className="form-select" value="" id="specificSizeSelect">
                                                ...
                                                <div className="address-type m-3">
                                                    <div className="mb-3">
                                                        ...
                                                        <input type="text" className="form-control" placeholder='Nhập tên đường/nhà' />
                                                    </div>
                                                </div>
                                                <div className="apply-button d-flex justify-content-end m-3">
                                                    <a className="btn btn-danger btn--m m-2">Hủy</a>
                                                    <a className="btn btn-success btn--m m-2" disabled="">Xác nhận</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            {/* Modal Image */}
            <div className="modal fade" id="updateImg" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                                    ...
                                    <div className="content-item">
                                        ...
                                        <div className="content-item address-list">
                                            <div className="content">
                                                ...
                                                {profilePicture ? (
                                                    <>
                                                        <img src={profilePicture} className="img-fluid rounded mx-auto d-block" />
                                                        <div className="input-field mt-3">
                                                            <button type="submit" className="btn-submit" onClick={updateImage}>Cập nhật</button>
                                                        </div>
                                                    </>
                                                ) : (
                                                    <></>
            ...
            {/* Modal Logout */}
            <div className="modal fade" id="customerLogout" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content text-center">
                        <div className="modal-body p-0">
                            <div className="d-flex flex-row-reverse p-2">
                                    ...
                                    <div className="content-item">
                                        ...
                                        <div className="content-item address-list">
                                            <div className="content">
                                                ...
                                                <div className="input-field mt-3">
                                                    <button type="submit" className="btn-submit" onClick={handleLogout}>Đăng xuất</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
