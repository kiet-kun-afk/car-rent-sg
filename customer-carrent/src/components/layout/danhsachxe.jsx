        ...
        <div className="row m-0">
          <div className="d-flex justify-content-center grid gap-5 mt-3 mb-3 text-body-secondary">
            ...
            <div className="timeCursor">
              <span data-bs-toggle="modal" data-bs-target="#filterDay">
                <i className="fa-solid fa-calendar-days fs-5"></i> {currentDay}{" "}
                - {nextDay}
              </span>
            </div>
          </div>
                      ...
                      <div className="col-sm-3 mt-1 mb-1">
                        ...
                        >
                          ...
                          <div className="card-body p-0">
                            <p className="card-text mb-3">Mini</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-sm-3 mt-1 mb-1">
                        <div
                          className="card card-style"
                          style={{ width: "8rem" }}
                          onClick={() => selectCategory("CUV Gầm cao")}
                        >
                          <img
                            src={cuv5}
                            className="img-fluid card-img-top m-auto"
                          ...
                          />
                          <div className="card-body p-0">
                            <p className="card-text mb-3">CUV Gầm cao</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-sm-3 mt-1 mb-1">
                        <div
                          className="card card-style"
                          style={{ width: "8rem" }}
                          onClick={() => selectCategory("SUV Gầm thấp")}
                        >
                          <img
                            src={suv7}
                            className="img-fluid card-img-top m-auto"
                          ...
                          />
                          <div className="card-body p-0">
                            <p className="card-text mb-3">SUV Gầm thấp</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-sm-3 mt-1 mb-1">
                        <div
                          className="card card-style"
                          style={{ width: "8rem" }}
                          onClick={() => selectCategory("Bán tải")}
                        >
                          <img
                            src={truck}
                            className="img-fluid card-img-top m-auto"
                          ...
                          />
                          <div className="card-body p-0">
                            <p className="card-text mb-3">Bán tải</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-sm-3 mt-1 mb-1">
                        <div
                          className="card card-style"
                          style={{ width: "8rem" }}
                          onClick={() => selectCategory("Minivan")}
                        >
                          <img
                            src={minivan}
                            className="img-fluid card-img-top m-auto"
                          ...
                          />
                          <div className="card-body p-0">
                            <p className="card-text mb-3">Minivan</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row m-0">
                      <div className="d-flex flex-wrap">
                        ...
                        <div className="custom-radio-brand mb-3">
                          ...
                          >
                            <input
                              ...
                              id="ford"
                            />
                            <label className="form-check-label" htmlFor="ford">
                              <img
                                loading="lazy"
                        ...
                        <div className="custom-radio-brand mb-3">
                          ...
                          >
                            <input
                              ...
                              id="lexus"
                            />
                            <label className="form-check-label" htmlFor="lexus">
                              <img
                                loading="lazy"
                        ...
                        <div className="custom-radio-brand mb-3">
                          ...
                          >
                            <input
                              ...
                              id="mazda"
                            />
                            <label className="form-check-label" htmlFor="mazda">
                              <img
                                loading="lazy"
                        ...
                        <div className="custom-radio-brand mb-3">
                          <div
                            className="form-check"
                            onClick={() => selectBrand("mitsubishi")}
                          >
                            <input
                              className="form-check-input"
                              type="radio"
                        ...
                        <div className="custom-radio-brand mb-3">
                          ...
                          >
                            <input
                              ...
                              id="volk"
                            />
                            <label className="form-check-label" htmlFor="volk">
                              <img
                                loading="lazy"
                        ...
                        <div className="custom-radio-brand mb-3">
                          ...
                          >
                            <input
                              ...
                              id="baic"
                            />
                            <label className="form-check-label" htmlFor="baic">
                              <img
                                loading="lazy"
