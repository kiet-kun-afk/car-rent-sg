...
function CustomerCar() {
	...
	const loadFilter = async () => {
		try {
			const brandsResponse = await axios.get(`http://localhost:8080/api/v1/brands`);
	...
	const filterDate = () => {
		if (date.startDate && date.endDate) {
			loadListCar(0, category, brand, transmission, fuelType, minSeat, maxSeat, minPrice, maxPrice);
		} else {
	...
	const handleChangePage = (currentPage) => {
		loadListCar(currentPage, category, brand, transmission, fuelType, minSeat, maxSeat, minPrice, maxPrice);
	};
		...
		<div className="carrent-layout">
			...
			<div className="c-container">
					...
					<div className="d-flex justify-content-center grid gap-5 mt-3 mb-3 text-body-secondary">
						...
						<div className="timeCursor">
							<span data-bs-toggle="modal" data-bs-target="#filterDay">
								<i className="fa-solid fa-calendar-days fs-5"></i> {currentDay} - {nextDay}
							</span>
						</div>
					</div>
				...
				<div className="row m-0">
					{cars.length > 0 ? (
						cars.map((car) => (
							<div className="col-sm-3 col-md-3 col-lg-3" style={{ padding: "12px 12px" }}>
								<a
									className="car-item"
									href="#"
									...
									<div className="car-item-box">
										<div className="car-item-img">
											...
											<div className="car-avatar">
												<img alt="" src="https://n1-cstg.mioto.vn/m/avatars/avatar-3.png" />
											</div>
					...
					<div className="modal-dialog modal-dialog-centered" style={{ minWidth: "600px" }}>
						<div className="modal-content text-center p-0">
								...
								<div className="form-item">
									<div className="content">
										...
										<div className="row m-0 text-start">
											<span>
												{`${formatVietnameseDate(date.startDate)} - ${formatVietnameseDate(
													date.endDate
												)}`}
											</span>
											<span>
							...
							<div className="modal-footer">
								<button type="button" className="btn btn-primary w-100" onClick={() => filterDate()}>
									{t("modal.apply")}
								</button>
							</div>
						</div>
												...
												<div className="col-sm-3 mt-1 mb-1" key={category.categoryName}>
													...
													>
														...
														<div className="card-body p-0">
															<p className="card-text mb-3">{category.categoryName}</p>
														</div>
													</div>
												</div>
											))}
				...
				>
					<div className="modal-dialog modal-dialog-centered" style={{ minWidth: "600px" }}>
						<div className="modal-content text-center p-0">
										...
										<div className="row m-0">
											<div className="d-flex flex-wrap">
												<div className="custom-radio-brand mb-3">
													<div className="form-check" onClick={() => selectBrand("")}>
														<input
							...
							<div className="modal-footer">
								<button type="button" className="btn btn-primary w-100" onClick={() => filterBrand()}>
									{t("modal2.apply")}
								</button>
							</div>
						</div>
								...
								<div className="form-item">
									<div className="content">
										<div className="row m-0">
											<div className="d-flex flex-wrap">
												<div className="custom-radio-brand mb-3">
													<div className="form-check" onClick={() => selectTransmission("")}>
														<input
															className="form-check-input"
															type="radio"
															name="flexRadioDefault"
															id="all-transmission"
														/>
														<label className="form-check-label" htmlFor="all-transmission">
															<p>{t("modal3.all")}</p>
														</label>
													</div>
												</div>
										...
										<div className="row m-0 pb-3">
											...
											<div className="d-flex flex-wrap p-0 mt-2 mb-2">
												<div className="custom-radio-fuel">
													<div className="form-check" onClick={() => selectFuelType("")}>
														<input
															className="form-check-input"
															type="radio"
												...
												<div className="custom-radio-fuel">
													<div className="form-check" onClick={() => selectFuelType("điện")}>
														<input
															className="form-check-input"
															type="radio"
															name="form-check-input"
												...
												<div className="custom-radio-fuel">
													<div className="form-check" onClick={() => selectFuelType("xăng")}>
														<input
															className="form-check-input"
															type="radio"
															name="form-check-input"
