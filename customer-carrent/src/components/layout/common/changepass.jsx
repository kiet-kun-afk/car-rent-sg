...
function Changepassword() {
    ...
    const handleChangepass = async (e) => {
        ...
        try {
            ...
            if (customerAccount) {
                const res = await axiosConfig.put("http://localhost:8080/api/v1/customers/change-password", formData, {
                    headers: {
            ...
            <div className="content-item change-pw">
                ...
                <div className="content">
                    <div className="custom-input">
                        ...
                        <div className="wrap-input ">
                            <div className="wrap-text">
                                <input className="form-control border-0 p-0" type={oldpasswordShow ? "text" : "password"} name="ip_pw" value={oldPassword} onChange={(e) => setOldPassword(e.target.value)} />
                            </div>
                            <div className="wrap-svg" onClick={toggleOldPassword}>
                                <svg width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <path
                                        ...
                                        stroke="black" stroke-width="1.5" strokeLinecap="round"
                    ...
                    <div className="custom-input">
                        ...
                        <div className="wrap-input ">
                            <div className="wrap-text">
                                <input className="form-control border-0 p-0" type={newpasswordShow ? "text" : "password"} name="ip_reset_pw" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} />
                            </div>
                    ...
                    <div className="custom-input">
                        ...
                        <div className="wrap-input ">
                            <div className="wrap-text">
                                <input className="form-control border-0 p-0" type={repasswordShow ? "text" : "password"} name="ip_reset_pw_confirm" value={confirmNewPassword} onChange={(e) => setConfirmNewPassword(e.target.value)} />
                            </div>
                            <div className="wrap-svg" onClick={toggleRePassword}>
                                <svg width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" xmlns="http:www.w3.org/2000/svg">
                                    <path
                                        d="M14.52 18.6297C13.71 18.8397 12.87 18.9397 12 18.9397C8.73 18.9397 5.8 17.4097 3.8 14.9897C2.4 13.2997 2.4 10.6897 3.8 9.00969C3.96 8.80969 4.14 8.61969 4.32 8.42969"
                    ...
                    <div className="apply-button"><a className="btn btn--m btn-success" onClick={handleChangepass}>Xác nhận</a></div>
                </div>
            </div>
            <ToastContainer />
        </>
