    ...
    return (
        ...
        <!-- Body --> */}
                ...
                <div className="body-banner">
                    <div className="c-container">
                        <div className="body-background">
                            ...
                            <h6>
                                Trải nghiệm sự khác biệt từ <span style={{ color: "#009966" }} >hơn
                                    2000</span> xe gia đình đời mới khắp Việt Nam
                            </h6>
                        </div>
                    </div>
                </div>
            ...
            <!-- <div className="promotion">
                ...
                <div className="c-container">
                    <div id="promotion" className="carousel slide">
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <div className="row">
                                    <div className="col-sm-4 col-lg-4 col-xs-4" style={{padding: "0px 20px"}}">
                                        <div className="promotion-item">
                                            <img className="promotion-img" alt="" src="/img/DatBruceLee.jpg">
                                        </div>
                                    </div>
                                    <div className="col-sm-4 col-lg-4 col-xs-4" style={{padding: "0px 20px"}}">
                                        <div className="promotion-item">
                        ...
                        <button className="carousel-control-prev" type="button" data-bs-target="#promotion"
                            data-bs-slide="prev">
                            <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span className="visually-hidden">Previous</span>
                        </button>
                        <button className="carousel-control-next" type="button" data-bs-target="#promotion"
                            data-bs-slide="next">
                    ...
                    <div className="c-container">
                        <div id="outstancity" className="carousel slide">
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                    <div className="row">
                                        <div className="col-sm-3 col-lg-3 col-xs-3" style={{ padding: "0px 10px" }}>
                                            <div className="city-item">
                                                <a href="">
                                                    <div className="city-item-img">
                                                        <img className="city-img" alt="" src="../img/HoChiMinh.jpg" />
                                                    </div>
                                                    <p>TP. HỒ CHÍ MINH</p>
                                                </a>
                                            </div>
                                        ...
                                        <div className="col-sm-3 col-lg-3 col-xs-3" style={{ padding: "0px 10px" }}>
                                            <div className="city-item">
                                                <a href="">
                                                    <div className="city-item-img">
                                                        <img className="city-img" alt="" src="../img/HaNoi.jpg" />
                                                    </div>
                                                    <p>HÀ NỘI</p>
                                                </a>
                                            </div>
                                        ...
                                        <div className="col-sm-3 col-lg-3 col-xs-3" style={{ padding: "0px 10px" }}>
                                            <div className="city-item">
                                                <a href="">
                                                    <div className="city-item-img">
                                                        <img className="city-img" alt="" src="../img/DaLat.jpg" />
                                                    </div>
                                                    <p>ĐÀ LẠT</p>
                                                </a>
                                            </div>
                                        ...
                                        <div className="col-sm-3 col-lg-3 col-xs-3" style={{ padding: "0px 10px" }}>
                                            <div className="city-item">
                                                <a href="">
                                                    <div className="city-item-img">
                                                        <img className="city-img" alt="" src="../img/VungTau.jpg" />
                                                    </div>
                                                    <p>VŨNG TÀU</p>
                                                </a>
                                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-sm-3 col-lg-3 col-xs-3" style={{ padding: "0px 10px" }}>
                                            <div className="city-item">
                                                <a href="">
                                                    <div className="city-item-img">
                                                        <img className="city-img" alt="" src="../img/DaNang.jpg" />
                                                    </div>
                                                    <p>ĐÀ NẴNG</p>
                                                </a>
                                            </div>
                                        ...
                                        <div className="col-sm-3 col-lg-3 col-xs-3" style={{ padding: "0px 10px" }}>
                                            <div className="city-item">
                                                <a href="">
                                                    <div className="city-item-img">
                                                        <img className="city-img" alt="" src="../img/QuyNhon.jpg" />
                                                    </div>
                                                    <p>QUY NHƠN</p>
                                                </a>
                                            </div>
                                        ...
                                        <div className="col-sm-3 col-lg-3 col-xs-3" style={{ padding: "0px 10px" }}>
                                            <div className="city-item">
                                                <a href="">
                                                    <div className="city-item-img">
                                                        <img className="city-img" alt="" src="../img/NhaTrang.jpg" />
                                                    </div>
                                                    <p>NHA TRANG</p>
                                                </a>
                                            </div>
                                        ...
                                        <div className="col-sm-3 col-lg-3 col-xs-3" style={{ padding: "0px 10px" }}>
                                            <div className="city-item">
                                                <a href="">
                                                    <div className="city-item-img">
                                                        <img className="city-img" alt="" src="../img/BinhDuong.jpg" />
                                                    </div>
                                                    <p>BÌNH DƯƠNG</p>
                                                </a>
                                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-sm-3 col-lg-3 col-xs-3" style={{ padding: "0px 10px" }}>
                                            <div className="city-item">
                                                <a href="">
                                                    <div className="city-item-img">
                                                        <img className="city-img" alt="" src="../img/CanTho.jpg" />
                                                    </div>
                                                    <p>CẦN THƠ</p>
                                                </a>
                                            </div>
                                        ...
                                        <div className="col-sm-3 col-lg-3 col-xs-3" style={{ padding: "0px 10px" }}>
                                            <div className="city-item">
                                                <a href="">
                                                    <div className="city-item-img">
                                                        <img className="city-img" alt="" src="../img/PhuQuoc.jpg" />
                                                    </div>
                                                    <p>PHÚ QUỐC</p>
                                                </a>
                                            </div>
                                        ...
                                        <div className="col-sm-3 col-lg-3 col-xs-3" style={{ padding: "0px 10px" }}>
                                            <div className="city-item">
                                                <a href="">
                                                    <div className="city-item-img">
                                                        <img className="city-img" alt="" src="../img/HaiPhong.jpg" />
                                                    </div>
                                                    <p>HẢI PHÒNG</p>
                                                </a>
                                            </div>
                            ...
                            <button className="carousel-control-prev" type="button" data-bs-target="#outstancity"
                                data-bs-slide="prev">
                                <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span className="visually-hidden">Previous</span>
                            </button>
                            <button className="carousel-control-next" type="button" data-bs-target="#outstancity"
                                data-bs-slide="next">
                                <span className="carousel-control-next-icon" aria-hidden="true"></span>
                                <span className="visually-hidden">Next</span>
                            </button>
                    ...
                    <div className="c-container">
                        ...
                        <div className="advan-container">
                            <div className="advan-item">
                                ...
                                <p>
                                    Chuyến đi trên Mioto được bảo vệ với Gói bảo hiểm thuê xe tự lái
                                    từ MIC & VNI. <br /> Khách thuê sẽ chỉ bồi thường tối đa
                                    2,000,000VNĐ trong trường hợp có sự cố ngoài ý muốn.
                                </p>
                            </div>
                            <div className="advan-item">
                                <div className="advan-item-img">
                                ...
                                <p>Không tính phí huỷ chuyến trong vòng 1h sau khi đặt cọc.
                                    Hoàn cọc và bồi thường 100% nếu chủ xe huỷ chuyến trong vòng 7
                                    ngày trước chuyến đi.</p>
                            </div>
                            <div className="advan-item">
                                <div className="advan-item-img">
                                ...
                                <p>Chỉ cần có CCCD gắn chip (Hoặc Passport) & Giấy phép lái
                                    xe là bạn đã đủ điều kiện thuê xe trên Mioto.</p>
                            </div>
                            <div className="advan-item">
                                <div className="advan-item-img">
                                ...
                                <p>Đa dạng hình thức thanh toán: ATM, thẻ Visa & Ví điện tử
                                    (Momo, VnPay, ZaloPay).</p>
                            </div>
                            <div className="advan-item">
                                <div className="advan-item-img">
                                ...
                                <p>Bạn có thể lựa chọn giao xe tận nhà/sân bay... Phí tiết
                                    kiệm chỉ từ 15k/km.</p>
                            </div>
                            <div className="advan-item">
                                <div className="advan-item-img">
                                ...
                                <p>Hơn 100 dòng xe cho bạn tuỳ ý lựa chọn: Mini, Sedan, CUV,
                                    SUV, MPV, Bán tải.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="service-item-left">
                                <div className="service-item-img">
                                    ...
                                    <div className="service-content">
                                        ...
                                        <p>
                                            Tự tay cầm lái chiếc xe mà bạn yêu thích <br /> cho hành
                                            trình thêm phấn khởi.
                                        </p>
                                        <a className="btn btn-success btn-service">Thuê xe tự lái</a>
                                    </div>
                                </div>
                            </div>
                            <div className="service-item-right">
                                <div className="service-item-img">
                                    ...
                                    <div className="service-content-right">
                                        ...
                                        <p>
                                            Chuyến đi thêm thú vị <br /> cùng các bác tài 5* trên CarR.
                                        </p>
                                        <a className="btn btn-success btn-service">Thuê xe có tài xế</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="tutor-background">
                    <div className="c-container">
                        ...
                        <h4>Chỉ với 4 bước đơn giản để trải nghiệm thuê xe với CarR
                            một cách nhanh chóng</h4>
