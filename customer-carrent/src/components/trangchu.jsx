      ...
      <div className="c-body">
          ...
          <div className="c-container">
            <div className="body-background">
              ...
              <h6>
                ...
                <span style={{ color: "#009966" }}>hơn 2000</span> xe gia đình
        ...
        <div className="advantage-background">
          <div className="c-container">
            ...
            <h4>
              Những tính năng giúp bạn dễ dàng hơn khi thuê xe trên CarRentSG
            </h4>
            <div className="advan-container">
              <div className="advan-item">
                ...
                <p>
                  Chuyến đi trên CarRentSG được bảo vệ với Gói bảo hiểm thuê xe
                  tự lái từ MIC & VNI. <br /> Khách thuê sẽ chỉ bồi thường tối
                  đa 2,000,000VNĐ trong trường hợp có sự cố ngoài ý muốn.
                </p>
              </div>
              <div className="advan-item">
                <div className="advan-item-img">
              ...
              <div className="advan-item">
                ...
                <p>
                  ...
                  bạn đã đủ điều kiện thuê xe trên CarRentSG.
                </p>
              </div>
              <div className="advan-item">
                <div className="advan-item-img">
              ...
              <div className="advan-item">
                ...
                <p>
                  Bạn có thể lựa chọn giao xe tận nhà/sân bay... Phí tiết kiệm
                  chỉ từ 15k/km.
                </p>
              </div>
              <div className="advan-item">
              ...
              <div className="service-item-right">
                <div className="service-item-img">
                  ...
                  <div className="service-content-right">
                    ...
                    <p>
                      Chuyến đi thêm thú vị <br /> cùng các bác tài 5* trên
                      CarR.
                    </p>
                    <a className="btn btn-success btn-service">
                      Thuê xe có tài xế
        ...
        <div className="tutor-background">
          <div className="c-container">
            ...
            <h4>
              Chỉ với 4 bước đơn giản để trải nghiệm thuê xe với CarR một cách
              nhanh chóng
            </h4>
