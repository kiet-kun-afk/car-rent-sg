...
import "../../styles/styleDetailCustomer.css";
      ...
      try {
        ...
        if (userAccount) {
          const res = await axiosConfig.put(
            "http://localhost:8080/api/v1/staff/change-password",
            formData,
            {
              headers: {
            ...
            <div className="content-item change-pw">
              ...
              <div className="content">
                <div className="custom-input">
                  ...
                  <div className=" mb-4 title-status {errors.oldPassword==null || checkOld.length > 0 ?'d-lg-none':'' }">
                ...
                <div className="custom-input">
                  ...
                  <div className=" mb-4 title-status {errors.newPassword==null?'d-lg-none':'' }">
                    <span className="error-item1 text-danger ">
                ...
                <div className="custom-input">
                  ...
                  <div className="mb-4 title-status {errors.confirmNewPassword==null?'d-lg-none':'' }">
                    <span className="error-item1 text-danger mb-5">
